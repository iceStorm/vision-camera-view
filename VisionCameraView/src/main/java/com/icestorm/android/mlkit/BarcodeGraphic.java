...
public class BarcodeGraphic extends GraphicOverlay.Graphic {
    ...
    private boolean drawTextBounder;
    private volatile Barcode mBarcode;

    public BarcodeGraphic(GraphicOverlay overlay, int textColor, float textSize, boolean drawTextBounder) {
        super(overlay);
        this.drawTextBounder = drawTextBounder;
